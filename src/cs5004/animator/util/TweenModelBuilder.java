 ...
 * calls as it reads a file containing the animation and builds a view It is
 * parameterized over the actual view type.
 */
...
public interface TweenModelBuilder<T> {
  ...
  /**
   * Return the view built so far.
   *
   * @return the view that was constructed so far
   */
  T build();
